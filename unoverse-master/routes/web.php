...
//Route::post('/links/cadEstudante/', [RegisterController::class, 'register'])->name('registrar'); #rota para confirmação via email
//Route::post('/email/verificaEmail/', [RegisterController::class, 'ConfirmCode'])->name('confirmar.code');
Route::post('/links/cadEstudante/', [PessoaController::class, 'cadastrar'])->name('registrar');
